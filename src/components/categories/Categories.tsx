...
const Categories = () => {
  return (
    <ul className='flex md:flex-col gap-8'>
      ...
      <li className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 min-w-[200px] cursor-pointer text-xl text-gray-400 hover:text-black'>
