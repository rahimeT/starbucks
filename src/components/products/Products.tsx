...
const Products = () => {
  return (
    <div className='product-wrapper grid gap-8 grid-cols-[repeat(auto-fill,_360px)] justify-center align-middle '>
      <div className='product-item shadow-2xl select-none transform motion-safe:hover:-translate-y-2 motion-safe:hover:scale-80 transition ease-in-out duration-500  border border-gray-200 bg-white rounded-lg  '>
        <img
        ...
        <div className='px-5 pb-5'>
          <h6 className='text-xl font-semibold tracking-tight text-gray-900  text-center pb-8'>
      ...
      <div className='product-item shadow-2xl select-none transform motion-safe:hover:-translate-y-2 motion-safe:hover:scale-80 transition ease-in-out duration-500  border border-gray-200 bg-white rounded-lg  '>
        ...
        />
        <div className='px-5 pb-5'>
          <h2 className='text-xl font-semibold tracking-tight text- text-gray-900  text-center pb-6'>
            kremali ppumpkin
          </h2>
          <h6 className='text-l font-thin italic tracking-tight text-gray-500  text-center pb-10'>
            Krema ile süslenmiş, karamel tatlılığı sunan espresso
          </h6>
